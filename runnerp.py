...
#set transfer model parameter:
    ...
    #priodic save model EHsan code:
    networkDir_ehsan = os.path.join(projectDir,"networks_ehsan")
    checkpoint_path_ehsan = "cp_{epoch}.ckpt"
    checkpoint_dir_ehsan = os.path.join(networkDir_ehsan,checkpoint_path_ehsan)
    modelSave_ehsan = os.path.join(checkpoint_dir_ehsan,"model_ehsan.json")
    weightsSave_ehsan = os.path.join(checkpoint_dir_ehsan,"weights_ehsan.h5")
    ######################################
    ...
    runModels(ModelFuncPointer=GRU_TUNED84,
            ...
            network=[modelSave,weightsSave,modelSave_ehsan,weightsSave_ehsan],
